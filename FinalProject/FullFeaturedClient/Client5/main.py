...
clientID = 5 # change accordingly to your client. If the client is HUMIDITY, this should be set
             ...
             # (with ALL type clients, the client id needs to be 5)
